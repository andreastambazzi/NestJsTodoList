...
La configurazione dell'applicativo si basa sia su file di configurazione di cui si possono trovare degli esempi nel percorso di progetto ***./config***
...
- ### Eseguzione locale
Per procedere all'eseguzione dell'applicativo, occorre una base dati mysql in locale o su macchina accessibile in rete.

I parametri di connessione sono nel file  ***config/config_dev.env***

- ### Eseguzione in docker
Occorre avere instalalto sulla propria macchina l'enviroment docker ***es: docker desktop***

```
https://www.docker.com/products/docker-desktop/
```

Anche per l'eseguzione in docer serve una base dati mysql raggiungibile dalla macchina dockerizzata

I parametri di connessione sono nel file ***config/config_prod.env***



## Api

Riferimenti e documentazione sulle api si possono trovare in formato json importabile su ***postman*** sotto il percorso di progetto ***./apidoc***
...
L'applicativo di default risponde sulla posta 3000
...
```bash
# per lanciare la compilazione docker e l'eseguzione del container
$ docker-compose up
```


L'applicativo di default risponde sulla porta ***3000***
